...
| Field | Details |
|---|---|
| **Student Name** | *Ajay Jangra* |
| **Registration Number** |  *24BAI10948*|
| **Chosen Software** | Git |
...
This repository contains an open-source project along with its explanation, working, and key features.
It includes details about the technologies used, dependencies, and how the project functions.
The purpose of this repository is to understand and explore the project in a simple and structured way.
Git is an open-source distributed version control system used to track changes in code.
It is written mainly in C and is designed to be fast, efficient, and reliable.
It allows developers to collaborate, manage versions, and maintain project history.
Git is widely used in software development and powers platforms like GitHub.
Overall, it makes team-based development easier and more organized.
...
│   ├── Script2_FOSS_Package_Inspector.sh                 ← FOSS Package Inspector
│   ├── Script3_Disk_and_Permission_Auditor.sh            ← Disk & Permission Auditor
│   ├── Script4_Log_File_Analyzer.sh                      ← Log File Analyzer
│   └── Script5_The_Open_Source_Manifesto_Generator.sh    ← Open Source Manifesto Generator
│
...
**File:** `Script3_Disk_and_Permission_Auditor.sh`
...
**File:** `Script5_The_Open_Source_Manifesto_Generator.sh`
...
```bash
git clone https://github.com/Ajay-200612/oss-audit-24BAI10948.git
...
**Script 3 — Disk and Permission Auditor**
```bash
./scripts/Script3_Disk_and_Permission_Auditor.sh
```
...
```bash
sudo ./scripts/Script3_Disk_and_Permission_Auditor.sh
```
...
**Script 5 — Open Source Manifesto Generator**
```bash
./scripts/Script5_The_Open_Source_Manifesto_Generator.sh
```
